...
router.get("/orders", protect, productionController.getOrders);
router.post("/orders", protect, productionController.createOrder);
router.put(
  "/orders/:id/status",
  protect,
  productionController.updateOrderStatus,
);
